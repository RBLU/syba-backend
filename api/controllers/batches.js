...
handler.getById = function (req, res, next) {
    ...
    Promise.all(
        [oracleRestHandler.statementRunner(req, res, next, queries.getBatchConfigById),
...
handler.reloadBatchConfig = (req, res, next) => {
    oracleRestHandler.statementRunner(req, res, next, getBatchConfigById)
        .then((batchConfig) => {
            ...
            Promise.all([oracleRestHandler.statementRunner(req, res, next, queries.deleteRuns),
                oracleRestHandler.statementRunner(req, res, next, queries.loadRuns)])
                .then((results) => {
